...
(function () {
  ...
  var CardComponent = /*#__PURE__*/function () {
    function CardComponent(id) {
      ...
      this.matched = false;
      this._id = id;
      this._imageElt = this.getElement().querySelector(".card-wrapper"); // TODO Step 3.2: use template literals (backquotes)
      // TODO Step 7: Update the path for images with 'src/app/components/game/card/assets/card***'

      this._imageElt.querySelector("img.front-face").src = "../game/card/assets/card-".concat(this._id, ".png");
